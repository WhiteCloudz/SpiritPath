//
//  DailyReadingChartTableViewCell.swift
//  SpiritPath
//
...
class DailyReadingChartTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        steckView.backgroundColor = UIColor.orange.withAlphaComponent(0.2)
